...
public class ProdutoTest {
    ...
    public void beforeEach(){
        ...
        this.token = given()
                ...
                .body(UsuarioDataFactory.logarUsuarioValidoAdmin("admin","admin"))
            .when()
                .post("/v2/login")
            .then()
                .extract()
    ...
    public void testValidarLimitesProibidosValorZeradoProduto(){
        ...
        //Tentar inserir um produto com o valor 0.00 e validar que a msg de erro foi apresentada e o
    ...
    @Test
    @DisplayName("Validar os limites proibidos do valor do Produto 7000.01 não é permitido")
